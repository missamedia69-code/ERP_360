...
/**
 * Écran Module CRM — Prospects, opportunités, pipeline commercial, activités,
 * campagnes marketing, scoring, historique relation client, objectifs commerciaux.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CrmScreen(onBack: () -> Unit) {
    val sousElements = ModuleSousElements.pourModule(ModuleCode.CRM)
