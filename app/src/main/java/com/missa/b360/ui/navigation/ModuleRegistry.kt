...
enum class AppModule(
    ...
    STOCK("module_stock", R.string.module_stock, Iv.Inventory2, ModuleCode.STK, prioriteBarre = 2, couleur = Color(0xFF059669)), 
    ...
    ACHATS("module_achats", R.string.module_achats, Iv.CartArrowDown, ModuleCode.ACH, couleur = Color(0xFFEA580C)), 
    ...
    PRODUCTION("module_production", R.string.module_production, Iv.LineWeight, ModuleCode.PRO, prioriteBarre = 6, couleur = Color(0xFF7C3AED)), 
    ...
    PROJETS("module_projets", R.string.module_projets, Iv.Workspaces, ModuleCode.PRJ, prioriteBarre = 5, couleur = Color(0xFF0EA5E9)), 
    COMPTABILITE("module_comptabilite", R.string.module_comptabilite, Iv.Calculator, ModuleCode.CPT, couleur = Color(0xFF334155)), 
    TRESORERIE("module_tresorerie", R.string.module_tresorerie, Iv.Bank, ModuleCode.TRE, prioriteBarre = 3, couleur = Color(0xFF1E40AF)), 
