...
/**
 * Écran Module Logistique (LOG) — Expéditions, transporteurs, bons d'expédition,
 * tracking, emballages, coûts logistiques, tournées de livraison, preuves.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun LogistiqueScreen(onBack: () -> Unit) {
    val sousElements = ModuleSousElements.pourModule(ModuleCode.LOG)
