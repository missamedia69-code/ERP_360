...
/**
 * Écran Module Qualité (QUA) — Plans de contrôle, contrôles qualité, non-conformités,
 * actions correctives, audits, réclamations clients, certifications, indicateurs.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun QualiteScreen(onBack: () -> Unit) {
    val sousElements = ModuleSousElements.pourModule(ModuleCode.QUA)
