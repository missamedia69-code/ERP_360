...
object GroupesStandards {
    ...
    val natureParCode: Map<String, ProductType> = mapOf(
        ...
        "PM" to ProductType.PIECE_MAINTENANCE,
        "EQUIP" to ProductType.EQUIPEMENT,
        "MAT" to ProductType.MATERIEL,
        "AB" to ProductType.AUTRE_BIEN,
        "SERV" to ProductType.PRESTATION,
        "SF" to ProductType.SEMI_FINI,
        "EMBAL" to ProductType.EMBALLAGE,
        "DV" to ProductType.DECHET_VALORISABLE,
        "DNV" to ProductType.DECHET_NON_VALORISABLE,
        "KIT" to ProductType.KIT,
        "CONS" to ProductType.CONSIGNATION,
    )
    ...
    fun modeles(referentiel: String?, maintenant: Long): List<ModeleGroupe> {
        ...
        return listOf(
            ...
            modele(
                code = "PM",
                nom = "Pièces & maintenance",
                description = "Pièces de rechange consommées par les interventions.",
                maintenant = maintenant,
                compteStock = c.stockMatieres,
                compteCharge = c.achatMatieres,
                compteProduit = null,
            ...
            modele(
                code = "MAT",
                nom = "Matériel",
                description = "Matériel d'exploitation immobilisé et amortissable.",
                maintenant = maintenant,
                compteStock = null,
                compteCharge = null,
                compteProduit = null,
            ...
            modele(
                code = "AB",
                nom = "Autres biens",
                description = "Biens divers stockés, non destinés à la revente.",
                maintenant = maintenant,
                compteStock = c.stockMarchandises,
                compteCharge = c.achatMarchandises,
                compteProduit = null,
            ...
            modele(
                code = "SF",
                nom = "Produits semi-finis",
                description = "Intermédiaires de fabrication, revendables ou réutilisés.",
                maintenant = maintenant,
                compteStock = c.stockProduitsFinis,
                compteCharge = null,
                compteProduit = c.venteMarchandises,
            ...
            modele(
                code = "EMBAL",
                nom = "Emballages",
                description = "Contenants, conditionnements et consignes.",
                maintenant = maintenant,
                compteStock = c.stockMatieres,
                compteCharge = c.achatMatieres,
                compteProduit = null,
            ...
            modele(
                code = "DV",
                nom = "Déchets valorisables",
                description = "Revendus ou remis à un recycleur.",
                maintenant = maintenant,
                compteStock = c.stockMatieres,
                compteCharge = null,
                compteProduit = c.venteMarchandises,
            ...
            modele(
                code = "DNV",
                nom = "Déchets non valorisables",
                description = "Quantités à éliminer, suivies physiquement sans valeur.",
                maintenant = maintenant,
                compteStock = c.stockMatieres,
                compteCharge = null,
                compteProduit = null,
            ...
            modele(
                code = "KIT",
                nom = "Kits & ensembles",
                description = "Vendus en lot ou assemblés depuis leurs composants.",
                maintenant = maintenant,
                compteStock = c.stockProduitsFinis,
                compteCharge = null,
                compteProduit = c.venteMarchandises,
            ...
            modele(
                code = "CONS",
                nom = "Consignations",
                description = "Biens de tiers, propriété du partenaire contractuel.",
                maintenant = maintenant,
                compteStock = c.stockMarchandises,
                compteCharge = null,
                compteProduit = null,
